    ...
    public LogEntryOuterClass.LogEntry toProto() {
        ...
        /*
            * Each timestamp takes around 4 bytes of memory to write to a file. Since, I'm expecting this to be used for some kind of time series stuff.
            I'm using delta variant as timestamp values would always be monotonic (i.e same or increasing values).
            
            * So, timestamps can be written in only 1 byte because we are only storing differences compared to older timestamp.
        */
